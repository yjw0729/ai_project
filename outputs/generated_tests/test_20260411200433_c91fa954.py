...
# execution_id: 20260411200433_c91fa954
# generated_at: 2026-04-11T20:04:33.340084
...
def _request(
    ...
    print(f"\n========== HTTP REQUEST ==========\n"
          ...
          f"Headers: {json.dumps(_headers, ensure_ascii=False)[:500]}\n"
          f"Query: {_req_params_str}\n"
          f"Body: {_req_body_str}\n"
          f"Timeout: {timeout}s\n"
          f"================================\n")
    ...
    try:
        ...
        print(f"\n========== HTTP RESPONSE ==========\n"
              ...
              f"Headers: {json.dumps(dict(resp.headers), ensure_ascii=False)[:500]}\n"
              f"Body: {_resp_body_str}\n"
              f"=================================\n")
        return resp

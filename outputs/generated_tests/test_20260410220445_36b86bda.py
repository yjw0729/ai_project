...
# execution_id: 20260410220445_36b86bda
# generated_at: 2026-04-10T22:04:45.231291
...
def test_1_TEST_CASE_000000005():
    ...
    logger.info("【变量配置】从 preconditions 加载 1 个变量: %s", "{variables_json}")
    logger.info("=" * 60)
    ...
    logger.info("【请求体-变量替换详情】%s", "${TIMESTAMP}->1775829885")
    ...
    _resolved_body = {"data": {"bankCode": "", "notifyUrl": "http://mqhjshjkr.bm/ihb", "payMethod": "", "requestId": "651505", "rootMchId": "600600010996929", "batchActionList": [{"amount": "30", "bindId": "", "userId": "U3141383309692437", "payeeMno": "600600010996929", "payerMno": "", "contractNo": "OTSSH1000000111", "outTradeNo": "1775829885", "productInfos": [{"remark": "Lorem ipsum dolor sit amet", "orderNo": "OTNPRODUCT0001", "productNo": "iph1234", "orderAmount": 15, "productName": "iPhone X", "productCount": 1}], "divideAccountType": "00"}]}, "format": "123123", "version": "1.2", "requestId": "520544", "timestamp": "1775829885"}
    ...
    resp = _request(
        ...
        headers={},
        params=None,
        json_body={"data": {"bankCode": "", "notifyUrl": "http://mqhjshjkr.bm/ihb", "payMethod": "", "requestId": "651505", "rootMchId": "600600010996929", "batchActionList": [{"amount": "30", "bindId": "", "userId": "U3141383309692437", "payeeMno": "600600010996929", "payerMno": "", "contractNo": "OTSSH1000000111", "outTradeNo": "1775829885", "productInfos": [{"remark": "Lorem ipsum dolor sit amet", "orderNo": "OTNPRODUCT0001", "productNo": "iph1234", "orderAmount": 15, "productName": "iPhone X", "productCount": 1}], "divideAccountType": "00"}]}, "format": "123123", "version": "1.2", "requestId": "520544", "timestamp": "1775829885"},
        timeout=30,
    )
    ...
    # ---- 自动检查：业务 code 是否为 00000000 ----
    try:
        _biz_resp = resp.json()
    except Exception:
        _biz_resp = {}
    _biz_code = _biz_resp.get('code') if isinstance(_biz_resp, dict) else None
    if resp.status_code == 200 and _biz_code is not None and _biz_code != '00000000':
    ...
    logger.info('【业务code检查】code=%s, HTTP状态码=%d, 通过', _biz_code, resp.status_code)

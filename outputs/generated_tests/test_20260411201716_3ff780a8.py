...
# execution_id: 20260411201716_3ff780a8
# generated_at: 2026-04-11T20:17:16.720026
...
def _request(
    ...
    print(f"\n{'='*30} HTTP REQUEST {'='*30}          f"\n  [地址] {url}"          f"\n  [方法] {method.upper()}"          f"\n  [请求头] {json.dumps(_headers, ensure_ascii=False)[:600]}"          f"\n  [Query] {_req_params_str}"          f"\n  [请求体] {_req_body_str}"          f"\n  [超时] {timeout}s"          f"\n{'=' * 60}\n")

...
# execution_id: 20260413151139_6587b92d
# generated_at: 2026-04-13T15:11:39.515225
...
def test_1_TEST_CASE_000000005():
    ...
    logger.info("【请求体-变量替换详情】%s", '${TIMESTAMP}->1776064299')
    ...
    _resolved_body = {"data": {"bankCode": "", "notifyUrl": "http://mqhjshjkr.bm/ihb", "payMethod": "", "requestId": "637129", "rootMchId": "600600010996929", "batchActionList": [{"amount": "30", "bindId": "", "userId": "U3141383309692437", "payeeMno": "600600010996929", "payerMno": "", "contractNo": "OTSSH1000000111", "outTradeNo": "1776064299", "productInfos": [{"remark": "Lorem ipsum dolor sit amet", "orderNo": "OTNPRODUCT0001", "productNo": "iph1234", "orderAmount": 15, "productName": "iPhone X", "productCount": 1}], "divideAccountType": "00"}]}, "format": "123123", "version": "1.2", "requestId": "933230", "timestamp": "1776064299"}
    ...
    resp = _request(
        ...
        headers={},
        params=None,
        json_body={"data": {"bankCode": "", "notifyUrl": "http://mqhjshjkr.bm/ihb", "payMethod": "", "requestId": "637129", "rootMchId": "600600010996929", "batchActionList": [{"amount": "30", "bindId": "", "userId": "U3141383309692437", "payeeMno": "600600010996929", "payerMno": "", "contractNo": "OTSSH1000000111", "outTradeNo": "1776064299", "productInfos": [{"remark": "Lorem ipsum dolor sit amet", "orderNo": "OTNPRODUCT0001", "productNo": "iph1234", "orderAmount": 15, "productName": "iPhone X", "productCount": 1}], "divideAccountType": "00"}]}, "format": "123123", "version": "1.2", "requestId": "933230", "timestamp": "1776064299"},
        timeout=30,
    )
    _extracted_data = {}

...
# execution_id: 20260410224345_3ae6eea0
# generated_at: 2026-04-10T22:43:45.340698
...
def test_1_TEST_CASE_000000005():
    ...
    logger.info("【请求体-变量替换详情】%s", "${TIMESTAMP}->1775832225")
    ...
    _resolved_body = {"data": {"bankCode": "", "notifyUrl": "http://mqhjshjkr.bm/ihb", "payMethod": "", "requestId": "930346", "rootMchId": "600600010996929", "batchActionList": [{"amount": "30", "bindId": "", "userId": "U3141383309692437", "payeeMno": "600600010996929", "payerMno": "", "contractNo": "OTSSH1000000111", "outTradeNo": "1775832225", "productInfos": [{"remark": "Lorem ipsum dolor sit amet", "orderNo": "OTNPRODUCT0001", "productNo": "iph1234", "orderAmount": 15, "productName": "iPhone X", "productCount": 1}], "divideAccountType": "00"}]}, "format": "123123", "version": "1.2", "requestId": "349843", "timestamp": "1775832225"}
    ...
    resp = _request(
        ...
        headers={},
        params=None,
        json_body={"data": {"bankCode": "", "notifyUrl": "http://mqhjshjkr.bm/ihb", "payMethod": "", "requestId": "930346", "rootMchId": "600600010996929", "batchActionList": [{"amount": "30", "bindId": "", "userId": "U3141383309692437", "payeeMno": "600600010996929", "payerMno": "", "contractNo": "OTSSH1000000111", "outTradeNo": "1775832225", "productInfos": [{"remark": "Lorem ipsum dolor sit amet", "orderNo": "OTNPRODUCT0001", "productNo": "iph1234", "orderAmount": 15, "productName": "iPhone X", "productCount": 1}], "divideAccountType": "00"}]}, "format": "123123", "version": "1.2", "requestId": "349843", "timestamp": "1775832225"},
        timeout=30,
    )

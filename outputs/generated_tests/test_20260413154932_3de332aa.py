...
# execution_id: 20260413154932_3de332aa
# generated_at: 2026-04-13T15:49:32.395609
...
def test_1_TEST_CASE_000000006():
    ...
    _extract_cfg = [{"name": "rateId", "path": "$.data.rateId"}, {"name": "uuid", "path": "$.data.uuid"}]
    ...
    _store_test_context("test_1_TEST_CASE_000000006", resp, _extracted_data)
    ...
    logger.info("【提取字段】配置数=2, 字段名: ['rateId', 'uuid']")
    logger.info("    提取配置: rateId <- $.data.rateId  ()")
    logger.info("    提取配置: uuid <- $.data.uuid  ()")

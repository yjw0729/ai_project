...
# execution_id: 20260413102111_ce351419
# generated_at: 2026-04-13T10:21:12.023604
...
def test_1_TEST_CASE_000000005():
    ...
    logger.info("【变量配置】从 preconditions 加载 1 个变量: %s", '{"payeeMno": "600600010996929"}')
    logger.info("=" * 60)
    ...
    logger.info("【请求体-变量替换详情】%s", '${TIMESTAMP}->1776046872')
    ...
    _resolved_body = {"data": {"bankCode": "", "notifyUrl": "http://mqhjshjkr.bm/ihb", "payMethod": "", "requestId": "614336", "rootMchId": "600600010996929", "batchActionList": [{"amount": "30", "bindId": "", "userId": "U3141383309692437", "payeeMno": "600600010996929", "payerMno": "", "contractNo": "OTSSH1000000111", "outTradeNo": "1776046872", "productInfos": [{"remark": "Lorem ipsum dolor sit amet", "orderNo": "OTNPRODUCT0001", "productNo": "iph1234", "orderAmount": 15, "productName": "iPhone X", "productCount": 1}], "divideAccountType": "00"}]}, "format": "123123", "version": "1.2", "requestId": "254058", "timestamp": "1776046872"}
    ...
    resp = _request(
        ...
        headers={},
        params=None,
        json_body={"data": {"bankCode": "", "notifyUrl": "http://mqhjshjkr.bm/ihb", "payMethod": "", "requestId": "614323322236", "rootMchId": "600600010996929", "batchActionList": [{"amount": "30", "bindId": "", "userId": "U3141383309692437", "payeeMno": "600600010996929", "payerMno": "", "contractNo": "OTSSH10002000111", "outTradeNo": "17763333046872", "productInfos": [{"remark": "Lorem ipsum dolor sit amet", "orderNo": "OTNPUCT0001", "productNo": "iph1234", "orderAmount": 15, "productName": "iPhone X", "productCount": 1}], "divideAccountType": "00"}]}, "format": "123123", "version": "1.2", "requestId": "253334222058", "timestamp": "1776046872"},
        timeout=30,
    )

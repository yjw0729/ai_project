# -*- coding: utf-8 -*-
# ============================================================
# pytest 测试文件 - execution_id: 20260410104125_f97035ca
# 生成时间: 2026-04-10 11:39:56
...
@pytest.mark.parametrize('case', [{"case_id": "TEST_CASE_000000006","name": "询价","method": "POST","path": "/v6/api/cashout/payment/common-payment-price","priority": "P0","headers": {"Content-Type": "application/json"},"params": null,"body": {"uuid": "59a13dfe60724428b61a2eb333785089","sesAmt": 11,"accuntId": 11221,"txnModel": "1","accountNo": "db701ea8062e405facfbf36eafd0bd0d","reqSource": "WEB","chargeType": "SHA","paymentAmt": 11,"paymentWay": "SWIFT","accCurrency": "USD","realNameFlag": "1","deductFeeMode": "OUTER","paymentCountry": "CN","paymentWayName": "跨境SWIFT","vaBusinessType": "B2B","paymentCurrency": "USD","localSettleMethod": null,"supplierOrderType": "1"},"assertions": []}])
def test_api_TEST_CASE_000000006(http_session, execution_config, case):
    """参数化测试用例"""

...
CREATE TABLE IF NOT EXISTS `crosstest_review_summary` (
    ...
    `page_count` INT DEFAULT 0 COMMENT '文档页数',
    `flow_chart_count` INT DEFAULT 0 COMMENT '流程图数量',
    ...
    `project_background` TEXT DEFAULT NULL COMMENT '项目背景与目标',
    `business_summary` TEXT DEFAULT NULL COMMENT '业务摘要',

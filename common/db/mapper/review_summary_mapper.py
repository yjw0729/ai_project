...
from common.db.entity.review_summary import ReviewSummary
...
class ReviewSummaryMapper:
    ...
    def upsert(self, doc_id: str, document_title: str = None, business_module: str = None,
               document_type: str = None, interface_count: int = 0, page_count: int = 0,
               flow_chart_count: int = 0, image_count: int = 0,
               ...
               project_background: str = None, business_summary: str = None) -> dict:
        """
        ...
        with self.session_scope() as session:
            ...
            if entity is None:
                entity = ReviewSummary(
                    ...
                    flow_chart_count=flow_chart_count,
                ...
                update_vals["page_count"] = page_count
                update_vals["flow_chart_count"] = flow_chart_count
                ...
                if project_background is not None:
                    update_vals["project_background"] = project_background
                if business_summary is not None:
                    update_vals["business_summary"] = business_summary
                session.execute(

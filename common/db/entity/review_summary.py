...
class ReviewSummary(Base):
    ...
    page_count            = Column(Integer, default=0, comment='文档页数')
    flow_chart_count      = Column(Integer, default=0, comment='流程图数量')
    ...
    # 需求文档摘要（来自预分析）
    project_background = Column(Text, comment='项目背景与目标')
    ...
    def to_dict(self):
        return {
            ...
            'flow_chart_count':    self.flow_chart_count,
